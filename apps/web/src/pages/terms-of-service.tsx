...
const TermsOfService = () => {
  return (
    <Container>
      <Text as="h1">Pepe-X Terms of Service</Text>
      ...
      <Text as="p">
        ...
        limited to Base Chain, that allow users to trade certain compatible digital assets (“the Pepe-X protocol” or the
      ...
      <Text as="p">
        ...
        source-available self-executing smart contracts that are deployed on various public blockchains. Pepe-X does not
        control or operate any version of the Protocol on any blockchain network. By using the Website, you understand
        that you are not buying or selling digital assets from us and that we do not operate any liquidity pools on the
        Protocol or control trade execution on the Protocol. When traders pay fees for trades, those fees accrue to
        liquidity providers for the Protocol. As a general matter, the Pepe-X team is not a liquidity provider into
        Protocol liquidity pools and liquidity providers are independent third parties. The Protocol was initially
        deployed on the Base Chain blockchain, and may be deployed on several other blockchain networks.
      </Text>
      ...
      <Text as="p">
        ...
        such as rarity scores, token explorer or token lists (which includes the Pepe-X default token list and Pepe-X
      ...
      <Text as="p">
        ...
        of any other digital tokens which are transacted on Pepe-X.
      </Text>
      <Text as="p">
      ...
      <Text as="p">
        ...
        representation or warranty about the safety or soundness of any cross-chain bridge, including its use for Pepe-X
        governance.
      </Text>
      <Text as="p">
      ...
      <Text as="p">
        ...
        potential dispute arises, you must contact us by sending an email so that we can attempt to resolve it without
        resorting to formal dispute resolution. If we aren't able to reach an informal resolution within sixty days of
        your email, then you and we both agree to resolve the potential dispute according to the process set forth
        below.
      </Text>
      <Text as="p">
      ...
      <Text as="p">
        ...
        as otherwise expressly set forth in the terms of another offer by Pepe-X, you will be solely responsible to pay
